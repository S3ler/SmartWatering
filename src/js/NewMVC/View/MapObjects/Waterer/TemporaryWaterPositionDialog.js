function SVGWatererInfoBox(svgMap, x, y, controller) {
...
SVGWatererInfoBox.prototype={
    ...
    createDivTop: function () {
        ...
        // append here for top
        divTop.appendChild(this.createTableDiv());
        return divTop;
    },
    ...
    getAvalaibleWaterers: function () {
        return this.simpleCircleBoundary;
    },
    setAvailaibleWaterers: function (waterers) {
        this.waterers = waterers;
    },
    ...
    dispatchKonfigureWatererMouseClick: function () {
        //this.controller.setCurrentWaterer(this.getSelectedWaterer);
    }
};
